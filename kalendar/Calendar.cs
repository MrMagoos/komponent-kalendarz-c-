...
namespace Calendar.NET
{
    ...
    public class Calendar : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this._btnToday = new Calendar.NET.TodayButton();
            this._btnLeft = new Calendar.NET.NavigateLeftButton();
            this._btnRight = new Calendar.NET.NavigateRightButton();
            ...
            this._btnToday.ButtonClicked += new Calendar.NET.CoolButton.ButtonClickedArgs(this.BtnTodayButtonClicked);
            ...
            this._btnLeft.ButtonClicked += new Calendar.NET.CoolButton.ButtonClickedArgs(this.BtnLeftButtonClicked);
            ...
            this._btnRight.ButtonClicked += new Calendar.NET.CoolButton.ButtonClickedArgs(this.BtnRightButtonClicked);
            // 
            // _contextMenuStrip1
            // 
